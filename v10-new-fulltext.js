...
let openBreadcrumbWrapper = '<div class="cell global-spacing--5x">';
let closeBreadcrumbWrapper = '</div>';
...
let openArticle = '<div class="grid-container global-spacing--5x"><div class="grid-x grid-margin-x"><div class="cell medium-8">';
...
/***
 *        Process T4 tags (for breadcrumbs nav object)
 */
...
* 
* */
let breadcrumbs = processTags('<t4 type="navigation" name="Breadcrumbs" id="955" />');
...
writeDocument(
    [
        ...
        closeSummary,
        closeSummaryWrapper,
        openBreadcrumbWrapper,
        breadcrumbs,
        closeBreadcrumbWrapper,
        endingHTML,
        openArticle,
        background,
